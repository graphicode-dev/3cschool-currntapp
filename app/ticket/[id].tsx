...
function getStatusStyle(status: string) {
  switch (status) {
    ...
    case "open":
      return { backgroundColor: "#fef3c7", color: "#d97706", label: "Open" };
    case "closed":
      return { backgroundColor: "#e5e7eb", color: "#6b7280", label: "Closed" };
    default:
      return { backgroundColor: "#e5e7eb", color: "#6b7280", label: status };
  }
}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.infoButton} onPress={fetchTicket}>
      ...
      >
        ...
        <View style={styles.inputArea}>
          ...
          <TouchableOpacity
            style={[
              styles.sendButton,
              messageText.trim() && !isSending ? styles.sendButtonActive : null,
            ]}
            onPress={handleSend}
