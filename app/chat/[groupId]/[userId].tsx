...
export default function PrivateChatScreen() {
  ...
  const mapMessageToDisplay = useCallback(
    (msg: Message): DisplayMessage => ({
      ...
      sender:
        msg.sender_id !== currentUserId ? msg.sender.full_name : undefined,
      senderAvatar:
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.avatarContainer}>
            <Ionicons name="person-outline" size={24} color="#00aeed" />
          </View>
        ...
        <FlatList
          ...
          ListFooterComponent={
            isLoadingMore ? (
              ...
              <View style={styles.dateSeparator}>
                <Text style={styles.dateSeparatorText}>Scroll up for more</Text>
              </View>
            ) : null
          }
          ListEmptyComponent={
